...
def raw_img_to_tens_pil(raw_img, MASK, xy=None, numpy_only=False):
...
def raw_img_to_tens_mar(raw_img, MASK, numpy_only=False):
    img = maxbin.img2int_mar(raw_img*MASK)
